...
<p>
Перейдя в раздел "Каталог" мы видим различные товары и кнопку добавить товар в корзину  и добавить новый товар.
</p>
...
<p>
Перейдя в раздел корзина, мы видим все товары которые были добавлены сюда. На самой карточке товара есть название товара и цена, а так же мы можем увеличить число товаров нажав на + или уменьшить нажав на - Так же мы увидим общую стоимость всех товаров в корзине
</p>
